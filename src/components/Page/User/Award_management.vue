<template>
    <div>
        ...
        <el-row>
            <el-col :span="7" v-for="(endRegistration,index) in endCompetition" :key="index" class="card">
                ...
                <div style="padding: 14px;">
                    ...
                    <div class="bottom clearfix">
                        <el-button type="text" class="button" @click="toEditAward(endRegistration)">查看比赛情况</el-button>
                    </div>
...
<script>
  export default {
    ...
    methods: {
      getdate(){
        let url='http://127.0.0.1:8888/message_board/endCompetition';
        this.$http.get(url).then(function(response){
            this.endCompetition=response.body.data; 
            }),
            function(response){
            }
      },
